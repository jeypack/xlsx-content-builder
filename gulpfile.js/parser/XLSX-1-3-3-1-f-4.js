...
/**
 * XLSX1331f4 XLSX-1-3-3-1-f-4.js
 * AUTHOR: J. Pfeifer (c) 2022
 * Created: 20.07.2022
 */
class XLSX1331f4 extends XLSXParser {
  /* constructor(template) {
    super(template);
    console.log("XLSX1331f4 constructor");
  } */

  _parse() {
    //let subclasses override this protected member function
    console.log("XLSX1331f4 extends XLSXParser - call protected method _parse");
    ...
    this._setFieldValue("module5", "AI36", 0, "TABLE");
    ...
    this._setFieldValue("module5", "AI37", 1, "TABLE");
    ...
    this._setFieldValue("module5", "AI38", 2, "TABLE");
    ...
    this._setFieldValue("module5", "AI40", 4, "TABLE");
...
module.exports.XLSX1331f4 = XLSX1331f4;